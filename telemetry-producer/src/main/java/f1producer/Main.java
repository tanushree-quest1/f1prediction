/**
 * Main entry point for the Java Telemetry Producer.
 * 
 * What it does: 
 * Initializes the Kafka producer and sets up the telemetry ingestion pipeline by discovering 
 * all driver CSV data files in the specified dataset directory.
 * 
 * Why it exists:
 * Serves as the bootstrap class for the streaming application, orchestrating the configuration
 * and kicking off the MergeCoordinator to stream data at the specified speed factor.
 */
package f1producer;
