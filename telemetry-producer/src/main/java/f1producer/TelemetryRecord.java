/**
 * Data Transfer Object (DTO) for a single telemetry event.
 * 
 * What it does:
 * Holds the parsed fields for a specific telemetry ping (e.g., speed, RPM, gear, lap time, x/y/z position) 
 * for a specific driver at a specific timestamp.
 * 
 * Why it exists:
 * Provides a strongly typed, serializable object that the application can easily pass around and serialize 
 * into JSON before publishing to the Kafka topic.
 */
package f1producer;
