/**
 * Parses and streams telemetry data from a CSV file.
 * 
 * What it does:
 * Implements the DriverStream interface to read a specific driver's CSV file line by line, 
 * converting the raw CSV rows into TelemetryRecord objects on demand.
 * 
 * Why it exists:
 * Allows the MergeCoordinator to lazily read from massive datasets without loading gigabytes 
 * of telemetry into memory at once, ensuring a low memory footprint.
 */
package f1producer;
