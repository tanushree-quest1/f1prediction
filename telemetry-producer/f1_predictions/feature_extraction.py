...
What it does:
Extracts and normalizes features from raw telemetry and current race state to prepare tensors 
for the XGBoost and Scikit-Learn models.

Why it exists:
Machine learning models require strictly formatted numerical inputs. This module bridges the gap 
between the raw dictionaries used in the application state and the NumPy arrays needed by the models.
"""
import numpy as np
import pandas as pd
