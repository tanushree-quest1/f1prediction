...
What it does:
Executes the specific business logic for interpreting model outputs (e.g. converting raw probabilities 
into ordered leaderboards or mapping categorical predictions).

Why it exists:
Separates the domain-specific logic of "what a prediction means for an F1 race" from the generic 
mathematics of the feature extraction and model execution layers.
"""
import numpy as np
import pandas as pd
