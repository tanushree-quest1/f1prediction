/**
 * Frontend WebSocket client and state manager.
 * 
 * What it does:
 * Connects to the FastAPI WebSocket server, parses the incoming real-time telemetry state, 
 * and updates the DOM elements (leaderboard, commentary, tire degradation bars) using vanilla JS.
 * 
 * Why it exists:
 * Provides the interactive, real-time visualization layer for the F1 telemetry pipeline without 
 * needing heavy frontend frameworks like React or Vue.
 */
'use strict';
